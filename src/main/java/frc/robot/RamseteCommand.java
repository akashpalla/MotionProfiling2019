...
public class RamseteCommand extends CommandBase {
  ...
  public void execute() {
    ...
    var targetWheelSpeeds = m_kinematics.toWheelSpeeds(
       ...
       var test = m_trajectory.sample(curTime);
       Pose2d test2 = test.poseMeters;
  //  SmartDashboard.putNumber("X2", test2.getTranslation().getX());
  //  SmartDashboard.putNumber("Y2", test2.getTranslation().getY());
    var leftSpeedSetpoint = targetWheelSpeeds.leftMetersPerSecond;
    var rightSpeedSetpoint = targetWheelSpeeds.rightMetersPerSecond;

    SmartDashboard.putNumber("LEFT STP", leftSpeedSetpoint);
    SmartDashboard.putNumber("RIGHT STP", rightSpeedSetpoint);
    double leftOutput;
    double rightOutput;
